...
response to any behaviour deemed inappropriate, threatening, offensive, or
harmful.
...
reported through the same private channel [SECURITY.md](SECURITY.md)
describes: GitHub's private reporting (**Security → Advisories → Report a
vulnerability**) on this repository. It is not only for vulnerabilities — it
is the private channel this project has, and conduct reports belong there
too. All complaints will be reviewed and investigated promptly and fairly.

The maintainer is obligated to respect the privacy and security of the
reporter of any incident. The same honesty applies here as in
[SECURITY.md](SECURITY.md#what-to-expect): this is a single-maintainer
project, so enforcement is one person's judgement rather than a committee's,
applied as promptly as that allows.
